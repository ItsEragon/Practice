    ...
    return (
        <Form method="POST" className='create-post'>
            ...
            <div className="mb-3">
                ...
                <textarea type="text" name="body" rows="4" className="form-control" id="body" placeholder='Tell more about it' />
            </div>
            <div className="mb-3">
                <label htmlFor="likes" className="form-label">Likes</label>
                <input type="number" name="likes" className="form-control" id="likes" placeholder='Number of likes' />
            </div>
            <div className="mb-3">
                <label htmlFor="dislikes" className="form-label">Dislikes</label>
                <input type="number" name="dislikes" className="form-control" id="dislikes" placeholder='Number of dislikes' />
            </div>
            <div className="mb-3">
